...
public static class NIGUI 
{
    ...
    /// @param lastClickPosition the position in which the click occurred. @note this is relevant only when returning true.
    ...
    /// @param rectToCorrectThe rect to correct. @note This will CHANGE the rect (even if the rect is clipped)
